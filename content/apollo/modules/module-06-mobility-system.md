---
module_id: 06
slug: mobility-system
title: Apollo Mobility System
phase: phase-1
order_in_phase: 5
tier: protocol
...
source_pdf: MOA_06_Apollo-Mobility-System_Notes_v1.pdf
lessons: 7
lede: "A strong man who cannot move well is not capable. He is a liability waiting to happen."
...
press overhead without excessive lower back arch. They cannot touch their toes. They have built
strength on top of dysfunction, and eventually the body presents the bill.

The Apollo physique is not just strong. It is mobile, fluid, controlled. Strength through full range of
motion. This is what separates the capable from the merely muscular.

Mobility is not stretching. Stretching is passive lengthening. Mobility is active control through range
...
ankle mobility shifts load to knees and lower back. Mobility limitations create compensation patterns
that leak power and invite injury.

Longevity: Most training injuries occur at end ranges under load - the exact positions you avoid
because they feel tight. Building strength and control at these ranges is insurance against injury. The
man who can move well at 50 trained mobility at 30.
...
impingement from pressing - their thoracic spine is locked up.
...
Hip Circles: Stand on one leg, draw circles with the opposite knee. 10 circles each direction, each
leg. Opens hip capsule and activates stabilisers.

Leg Swings: Hold something stable, swing one leg forward and back, then side to side. 10 swings
each direction, each leg. Dynamically stretches hamstrings, hip flexors, and adductors.

World's Greatest Stretch: From push-up position, step one foot outside same-side hand, drop
back hip toward ground, rotate torso toward front knee reaching arm to ceiling. Hold briefly, return,
repeat opposite side. 5 each side. This single movement addresses hip flexors, thoracic rotation,
and hamstrings.

Cat-Cow: On hands and knees, alternate between arching and rounding spine. 10 cycles. Mobilises
the entire spine and coordinates breath with movement.
...
Dead Bugs: 10 each side with controlled breathing. Activates deep core stabilisers.
...
Hip Flexor Stretch: Half-kneeling position, squeeze glute of back leg, shift hips forward gently.
Addresses the sitting damage that accumulates daily.

Pigeon or 90-90: External rotation stretch for hip capsule. Essential for squat depth and hip health.

Hamstring Stretch: Seated or supine, straight leg. Avoid rounding lower back - hinge from hips.

Lat Stretch: Hang from bar or use doorframe. Allows shoulder and lat to decompress after
pressing/pulling.

Chest/Pec Stretch: Arm against wall or doorframe at 90 degrees, rotate torso away. Opens chest
that becomes tight from pressing.
...
90-90 Hip Switches: Sitting with both knees at 90 degrees, rotate from one side to other, controlling
the transition. 10 each side. Builds hip internal and external rotation.

Deep Squat Hold: Sit in bottom of squat position, feet flat if possible, elbows pushing knees out
gently. Hold 2 minutes accumulated. This is the single most important position for human function -
reclaim it.

Thoracic Rotations: Quadruped position, one hand behind head, rotate elbow toward ceiling then
toward opposite elbow. 10 each side. Unlocks thoracic rotation that desk work destroys.

Wall Slides: Back against wall, arms in goalpost position against wall, slide arms up and down while
maintaining contact. 15 reps. Improves thoracic extension and shoulder mobility simultaneously.

Couch Stretch: Rear knee against wall or couch, front foot forward in lunge. The most aggressive
hip flexor stretch. Build up tolerance - this one is uncomfortable but transformative. 45-60 seconds
each side.
...
Extra attention to hips and ankles. Add:
  ...
  • Cossack squat transitions (10 each side)
...
Focus on thoracic spine and shoulders. Add:
  ...
  • Shoulder circles with light weight (10 each direction)
...
### DAILY NON-NEGOTIABLES:
 ...
 2. Post-training static stretching (5-10 minutes)
...
### ACTION ITEMS:
 ...
 2. Identify your primary restriction from the Big Three

 3. Add the Daily Flow to your morning or evening routine

 4. Never skip the pre-training protocol again

Mobility is earned through consistent practice, not occasional attention. Ten minutes daily beats
sixty minutes once per week.
